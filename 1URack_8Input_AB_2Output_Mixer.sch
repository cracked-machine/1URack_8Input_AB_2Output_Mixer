...
F 1 "25K" V 7250 1400 50  0000 C CNN
...
F 1 "25K" V 7350 4000 50  0000 C CNN
...
F 3 "" H 7550 8525 50  0001 C CNN
	...
	-1   0    0    -1  
$EndComp
Text Notes 10300 1725 0    60   ~ 0
For +6dB gain (x2):\n50K -> B100K\n22K -> B50K\n5K -> B10K
Text Notes 10300 1150 0    60   ~ 0
All VR_ChanX_OAout:\nCC = +6dB (x2)\nCCW = 0vpp
Text Notes 3025 4400 0    60   ~ 0
All VR_Faders:\nCC = Unity 0dB\nCCW = 0vpp\n
$Comp
L NPOT_LED VR_ChanA_OAout_Rf1
U 1 1 5B03827A
P 9000 1400
F 0 "VR_ChanA_OAout_Rf1" V 9450 1475 50  0000 C CNN
F 1 "B50K" V 9350 1400 50  0000 C CNN
F 2 "Bourn_PTL_Slider:Slider_PTL20_LED_35MM" H 9000 1400 50  0001 C CNN
